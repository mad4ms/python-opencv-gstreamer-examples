...
appsink2rtp_IntelMFX = "appsrc ! videoconvert ! mfxh264enc ! \
          video/x-h264, stream-format=byte-stream, profile=baseline ! \
          rtph264pay pt=96 ! udpsink host=127.0.0.1 port=5004"

# Multipass, ehm, multiCAST

# appsink2rtp_IntelMFX_multi = "appsrc ! videoconvert ! mfxh264enc ! \
#           video/x-h264, stream-format=byte-stream, profile=baseline ! \
#           rtph264pay pt=96 ! udpsink host=239.255.0.1 port=5004 auto-multicast=true
...
show = True
# Create videowriter
out = cv2.VideoWriter(appsink2rtp_IntelMFX, 0, fps,
